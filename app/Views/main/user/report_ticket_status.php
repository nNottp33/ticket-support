     ...
     <div class="container-fluid">
         ...
         <div class="row">
             <div class="col-sm-12 col-md-6 col-lg-3">
                 ...
                 <form class="mt-1">
                     <div class="form-group">
                         <input name="searchReportStatusStartDate" id="searchReportStatusStartDate" type="date"
                             class="form-control">
                     </div>
                 </form>
             </div>
             ...
             <div class="col-sm-12 col-md-6 col-lg-3">
                 ...
                 <form class="mt-1">
                     <div class="form-group">
                         <input name="searchReportStatusEndDate" id="searchReportStatusEndDate" type="date"
                             class="form-control">
                     </div>
                 </form>
             </div>
                 ...
                 <form class="mt-1">
                     <div class="form-group">
                         <select id="selectReportStatus" data-actions-box="true" title="เลือกสถานะ"
                             ...
                             <option value="5">Reject change admin</option>
                         </select>
                     </div>
                 </form>
             </div>
 ...
 <!-- ticket detail modal -->
 <div class="modal fade clear-modal" id="reportTicketStatusDetailModal" data-bs-backdrop="static"
     data-bs-keyboard="false" tabindex="-1" aria-labelledby="reportTicketAllDetailModalLabel" aria-hidden="true">
